...
> 本文件區分「計畫案例」與「已執行結果」。除明確註記已於 2026-07-29 或 2026-07-30 執行者外，其餘一律標為 `Not Run`，不可視為 Passed。
...
| Test ID | 測試目的 | 前置條件 | 操作步驟 | 預期結果 | 實際狀態 |
|---|---|---|---|---|---|
| TC-ROLE-001 | HR 入口與導覽 | 開啟首頁 | 點 HR Demo | 顯示 HR 工作區、總覽與候選人，不顯示題庫／審核中心 | Passed：2026-07-30 人工回歸；完整負向權限檢查 Not Run |
| TC-ROLE-002 | 技術主管入口與導覽 | 開啟首頁 | 點技術主管 Demo | 顯示工作台、題庫、面試組卷、審核中心 | Passed：2026-07-30 人工回歸題庫、組卷、審核；邀請操作未重跑 |
| TC-ROLE-003 | 面試者入口與導覽 | 開啟首頁 | 點面試者 Demo | 顯示自己的面試驗證，不顯示內部側欄 | Passed：2026-07-30 人工回歸 |
...
| TC-CAND-001 | 面試者核心提交路徑 | 面試者 Demo | 驗證→說明→作答一題→返回檢查→提交未完成答案 | 進入完成頁且顯示實際完成題數 | Passed：2026-07-30 人工操作；提示步驟另列 Not Run |
...
| TC-ANSWER-001 | 作答與切題 | 已開始面試 | 輸入答案後切換題目 | 工作階段內答案保留，題目導覽反映已作答，倒數不重置 | Passed：2026-07-30 人工操作一題後切題並返回 |
