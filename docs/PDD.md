...
1. **角色聚焦**：HR 看招募進度與摘要；技術主管看答案、AI 對話紀錄與詳細評估；面試者只接觸自己的面試流程。
2. **AI 可解釋、可推翻**：AI 提供初評與證據，人工分數獨立可修改。
3. **自由協作、責任清楚**：候選人可要求解釋、檢查或較完整解法；AI 可能出錯，最終答案仍由候選人負責。
...
- AI 對話允許自由協作；Mock 與 Gemini 模式必須透明標示，不以 AI 回覆自動評分或決策。

## Sprint 6A AI 產品邊界

候選人對話經 TalentScope server endpoint 傳送；只包含當前題目、候選人訊息與同面試同題最近 8 則成功對話。Email、驗證碼、姓名、招募決策、HR 備註及技術主管評語刻意排除。所有訊息僅存於目前瀏覽器工作階段，正式 Gemini 連線仍取決於部署端安全設定。
...
| Mock AI 對話與初評 | 受控 AI Service、內容安全與模型稽核 |
